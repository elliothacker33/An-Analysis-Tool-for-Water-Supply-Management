...
class Manager{
    ...
    /**
     * @brief Auxiliary function to parse numbers in Csv files.
    */

    int parseInt(const string& text) const;
...
public:
     ...
     * @param pathPipes The path to the file containing pipe BABA data.
     */
